...
export default function Hero() {
  const gradient = useMemo(
    () => 'bg-[radial-gradient(1200px_600px_at_50%_-10%,rgba(250,204,21,0.15),transparent_60%),radial-gradient(800px_400px_at_80%_10%,rgba(34,197,94,0.12),transparent_60%)]',
    []
  )

  return (
    <header className={`relative overflow-hidden ${gradient}`}>
      <div className="absolute inset-0 pointer-events-none opacity-40">
        <div className="absolute -top-24 -right-24 w-[480px] h-[480px] rounded-full blur-3xl bg-yellow-400/20" />
        <div className="absolute -bottom-24 -left-24 w-[520px] h-[520px] rounded-full blur-3xl bg-green-400/20" />
      </div>
        ...
        <div className="grid lg:grid-cols-2 items-center gap-10">
          <div>
            ...
            <ul className="mt-6 grid grid-cols-1 sm:grid-cols-2 gap-3 text-white/80 text-sm">
              <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-emerald-400"/>$0 upfront capex</li>
              <li className="flex items-center gap-2"><span className="h-1.5 w-1.5 rounded-full bg-yellow-300"/>Guaranteed savings</li>
          ...
          <div className="relative">
            <div className="absolute -inset-1 rounded-2xl bg-gradient-to-br from-yellow-300/30 via-emerald-300/30 to-sky-300/30 blur-xl" />
            <div className="relative rounded-2xl bg-slate-900/70 border border-white/10 p-6 sm:p-8 backdrop-blur-md shadow-2xl">
              <div className="flex items-center gap-3">
                <div className="h-10 w-10 rounded-lg bg-gradient-to-br from-yellow-400 to-emerald-400" />
                <div>
                  <p className="text-white font-semibold leading-tight">Free Solar Assessment</p>
                  <p className="text-white/60 text-sm">Find out your savings in 48 hours</p>
                </div>
              </div>
              <div className="mt-6 grid grid-cols-3 gap-4 text-center">
                <div>
                  <p className="text-2xl font-bold text-white">30%+</p>
                  <p className="text-xs text-white/60">Avg. bill reduction</p>
                </div>
                <div>
                  <p className="text-2xl font-bold text-white">24-48h</p>
                  <p className="text-xs text-white/60">Savings proposal</p>
                </div>
                <div>
